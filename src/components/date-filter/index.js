...
export default function DateFilter(props){
    const {start_date, end_date, additionalInputs, register, errors, handleSubmit, onSubmitForm} = props
    ...
    return (
        <div className="py-2">
            <div className="grid grid-cols-3 gap-x-4 gap-y-2 items-end">
                ...
                <Button text="Filter" variant="primary" attrs={{onClick: handleSubmit(onSubmitForm), type: "submit"}}/>
            </div>
            <hr className="my-2"/>
        </div>
    )
